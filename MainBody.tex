...
\documentclass[professional,master,approval,kfont=]{./Template/scuthesis2020}
\begin{document}
% 设置文档信息
\unitid{10610} % 单位代码
...
% 自动制作封面
\maketitle
% 自动制作中英文声明，请注意修改./Chapters/Statement.tex中的中文声明
\makestatement
% 设置论文正文前的页码、页眉等
...
\begin{reference}
	% 如果gbt7714包版本为2.0.x，需要将下行解除注释，或者安装1.1.1版本
