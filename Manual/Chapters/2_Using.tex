...
\section{使用}
\label{Sect_Using}
如果您是初学者，若要正确使用本模版，需要了解一些有关~\LaTeX~的基础知识，请见\cref{Subsect_LaTeXBasics,Subsect_InsertFormula,Subsect_InsertFigureTable}。如果您能够熟练使用或对~\LaTeX~有所了解，请移步至\cref{Subsect_UsingInDetail}。
