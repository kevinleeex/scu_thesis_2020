...
\section{使用}
\label{Sect_Using}
如果您是初学者，若要正确使用本模版，需要了解一些有关~\LaTeX~的基础知识，请见\cref{Subsect_LaTeXBasics}。如果您能够熟练使用或对~\LaTeX~有所了解，请移步至\cref{Subsect_UsingInDetail}。
\subsection{\LaTeX~文档的基础知识}
\label{Subsect_LaTeXBasics}
一般来说，一份完整的~\LaTeX~文档可分为\emph{导言区}和\emph{正文区}两大部分。其中\emph{导言区}位于\emph{正文区}之前，用于加载、描述、定义或重定义文档的类型、所用到的宏包、命令、环境等。
\begin{Verbatim}[gobble=1,frame=single]
	% 导言区
