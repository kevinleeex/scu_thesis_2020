...
此外，对于公式的输入还有很多内容，推荐访问~\url{https://en.wikibooks.org/wiki/LaTeX/Mathematics}~以及\incite{Book_LaTeXIntro}，获得更多信息。

\subsection{图表}
\label{Subsect_InsertFigureTable}
本模版默认加载了~\verb|graphicx|~宏包以提供在文中插入图片的功能。
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{../Template/Components/Images/SCU_TITLE}
